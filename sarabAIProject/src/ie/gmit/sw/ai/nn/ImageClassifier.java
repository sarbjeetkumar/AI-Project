...
public class ImageClassifier {
	...
	public ImageClassifier(String directory) throws Exception{
		...
		//Configure Neural Network Here
		 ...
		 //squash data with normalize between zero and one
		 trainer.train(Utils.normalize(data, 0, 1), Utils.normalize(expected, 0, 1), 1.2/*fine tune with MOMENTUM in BackpropagationTrainer class*/, 10000);
